const A={sections:[{id:1,title:"引言 — 从Web1.0走向Web4.0",icon:"Globe",content:`"每一次互联网跃迁，都是一次文明范式的重构。"
...
**WA is not a platform. It is a world.**`}]};export{A as whitepaperContent_zh};
