const e={sections:[{id:1,title:"บทนำ — จาก Web1.0 สู่ Web4.0",icon:"Globe",content:`"ทุกครั้งที่อินเทอร์เน็ตก้าวกระโดด คือการรื้อสร้างกรอบอารยธรรมใหม่"
...
WA Protocol จึงถือกำเนิดขึ้นในเวลาที่เหมาะสม。`},{id:2,title:"รากฐานเชิงปรัชญาของ Web4.0 และพันธกิจของ WA",icon:"Brain",content:`**การรื้อสร้างกระบวนทัศน์: จาก “ผลิตภัณฑ์อินเทอร์เน็ต” สู่ “ระบบการอยู่รอดดิจิทัล”**
...
> ไม่มี “พิมพ์ไม่จำกัด” และไม่มี “กำไรแบบไม่มีต้นทุน”`},{id:3,title:"ตำแหน่งของ WA: โปรโตคอลการทำงานร่วมกันแบบไวรัลที่ไร้สิทธิพิเศษ",icon:"Network",content:`**WA คืออะไร? ไม่ใช่แพลตฟอร์ม ไม่ใช่ผลิตภัณฑ์ แต่คือโปรโตคอล**
...
| Private Domain Authorization | รวมโมดูลของคนอื่น เพื่อนำความสามารถการแพร่กระจายกลับมาใช้ซ้ำ |`},{id:4,title:"สถาปัตยกรรมทางเทคนิค: ระบบปฏิบัติการ on-chain ของ Web4.0",icon:"Code",content:`**จาก "DApp" สู่ "On-chain OS": การเปลี่ยนกระบวนทัศน์ครั้งใหญ่**
...
WA Protocol คือ “ระบบปฏิบัติการบนเชน” ที่ไม่ต้องควบคุม ไม่ต้องอนุญาต ไม่ต้องเซิร์ฟเวอร์。`},{id:5,title:"การออกแบบกลไกหลัก: จากการเติบโตแบบไวรัลสู่การทำงานอัตโนมัติ",icon:"Settings",content:`**จากการเติบโตแบบไวรัลของผู้ใช้ → ผลิตมูลค่า → ระบบทรงตัวเอง — โมเดลการทำงานแบบปิดลูปเต็มรูปแบบ**
...
สรุป: แรงจูงใจทุกส่วนมีต้นทุน ผลผลิตทุกหน่วยมีความรับผิดชอบรองรับ.`},{id:6,title:"ระบบเศรษฐกิจโทเคนคู่: WANT และ XANT",icon:"Gem",content:`**ทำไมต้องใช้โมเดลโทเคนคู่?**
...
> โทเคนคู่ช่วยให้ WA มีทั้ง “เกณฑ์เริ่มต้น” และ “กลไกสมดุลตัวเอง” เพื่อรันระยะยาว.`},{id:7,title:"วงจรปิดธุรกิจ: ระบบสร้างเลือดและกฎเกณฑ์แรงจูงใจ",icon:"TrendingUp",content:`**พื้นหลัง: ทำไม 90% ของโปรเจ็กต์ Web3 "เลี้ยงตัวเองไม่ได้"?**
...
WA ไม่ใช่ "โปรเจ็กต์ที่ออกโทเคน" แต่เป็น "โปรโตคอลเศรษฐกิจที่สร้างรายได้จริงและกระจายอย่างโปร่งใสบนเชน"`},{id:8,title:"ระบบควบคุมความเสี่ยงและการออกแบบความยั่งยืน",icon:"Shield",content:`**ทำไมการควบคุมความเสี่ยงต้อง "native-protocol"?**
...
WA ไม่พึ่งพา "คนซื่อสัตย์" แต่พึ่งพา "ระบบที่ควบคุมตัวเอง"`},{id:9,title:"แผนงานและแผนพัฒนาตามขั้นตอน",icon:"Map",content:`**หลักการพัฒนา WA: "โปรโตคอลก่อน ผลิตภัณฑ์ตามหลัง"**
...
WA Protocol พัฒนาไม่ใช่เพราะ "ทีมผลักดัน" แต่เพราะ "โปรโตคอลดึงดูดผู้เข้าร่วมที่เหมาะสมในเวลาที่เหมาะสม"`},{id:10,title:"การออกแบบระบบนิเวศ MiniApp: พื้นที่อธิปไตยดิจิทัล Private Domain",icon:"Layout",content:`**MiniApp ใน WA คืออะไร?**
...
MiniApp คือวิธีที่ WA ทำให้วิสัยทัศน์ "อินเทอร์เน็ตของผู้ใช้" เป็นจริง`},{id:11,title:"โครงสร้างทีมและภูมิหลัง",icon:"Users",content:`**ปรัชญาทีม WA: "โปรโตคอลใหญ่กว่าทีม"**
...
เป้าหมายสุดท้าย: WA Protocol ทำงานได้อย่างสมบูรณ์โดยไม่พึ่งพาทีมหลักใดๆ`},{id:12,title:"บทส่งท้าย: วิสัยทัศน์ Web4.0 และคำเชิญร่วมสร้าง",icon:"Flag",content:`**WA Protocol ไม่ใช่แค่โปรเจ็กต์ — เป็นการทดลองอารยธรรมดิจิทัล**
...
WA Protocol: Build the future. Together.`}]};export{e as whitepaperContent_th};
