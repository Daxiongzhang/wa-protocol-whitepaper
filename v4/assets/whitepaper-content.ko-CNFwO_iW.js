const e={sections:[{id:1,title:"서문 — Web1.0에서 Web4.0으로",icon:"Globe",content:`"인터넷이 한 번 도약할 때마다, 문명 패러다임은 다시 짜인다."
...
WA Protocol, 바로 이 흐름 속에서 탄생한다.`},{id:2,title:"Web4.0의 철학적 기반과 WA의 사명",icon:"Brain",content:`**패러다임의 재구성: “인터넷 제품”에서 “디지털 생존 시스템”으로**
...
WA Protocol은 우리가 미래를 위해 구축하는 “문명 시스템의 바닥”이다.`},{id:3,title:"WA의 포지셔닝: Permissionless 바이럴 협업 프로토콜",icon:"Network",content:`**WA란 무엇인가? 플랫폼도 제품도 아닌, 프로토콜이다**
...
WA Protocol은 “자가 전파, 자가 실행, 자가 제약” 능력을 갖춘 Web4.0급 트래픽 프로토콜이다.`},{id:4,title:"기술 아키텍처: Web4.0의 온체인 운영체제",icon:"Code",content:`**"DApp"에서 "On-chain OS"로: 패러다임 전환**
...
WA Protocol은 통제/허가/서버 없이도 작동하는 “온체인 운영체제”로서 Web4.0 인프라를 제공합니다.`},{id:5,title:"핵심 메커니즘 설계: 바이럴 성장에서 자율성으로",icon:"Settings",content:`**사용자 바이럴 성장 → 가치 산출 → 시스템 자가 안정화 — 완전한 폐루프 운영 모델**
...
WA의 메커니즘은 모든 인센티브에 비용을 동반시키고, 모든 산출에 책임을 부여하여 — 온체인에서 “인센티브 × 책임 결합 × 자율 실행” 생태를 실현합니다.`},{id:6,title:"듀얼 토큰 경제 시스템: WANT와 XANT",icon:"Gem",content:`**왜 듀얼 토큰 모델인가?**
...
> 듀얼 토큰은 WA가 장기적으로 운영될 수 있도록 “시작 문턱”과 “자가 균형 메커니즘”을 동시에 제공합니다.`},{id:7,title:"비즈니스 클로즈드 루프: 조혈 시스템과 인센티브 규칙",icon:"TrendingUp",content:`**배경: 왜 90%의 Web3 프로젝트가 "자생할 수 없는가"?**
...
WA는 "토큰을 발행하는 프로젝트"가 아니라, "실질 수익을 생성하고 온체인에서 투명하게 분배하는 경제 프로토콜"입니다.`},{id:8,title:"리스크 관리 시스템과 지속가능성 설계",icon:"Shield",content:`**왜 리스크 관리가 "프로토콜 네이티브"여야 하는가?**
...
WA는 "정직한 사람"에 의존하지 않고 "자기 조절 시스템"에 의존합니다.`},{id:9,title:"로드맵과 단계별 개발 계획",icon:"Map",content:`**WA 개발 원칙: "프로토콜 우선, 프로덕트 후행"**
...
WA 프로토콜은 "팀이 추진하는" 것이 아니라, "프로토콜이 적절한 시점에 적절한 참여자를 끌어들이는" 것으로 발전합니다.`},{id:10,title:"MiniApp 생태계 설계: 프라이빗 도메인 디지털 주권 공간",icon:"Layout",content:`**WA에서 MiniApp이란?**
...
MiniApp은 WA가 "사용자의 인터넷" 비전을 실현하는 방법입니다.`},{id:11,title:"팀 구성과 배경",icon:"Users",content:`**WA 팀 철학: "프로토콜이 팀보다 크다"**
...
최종 목표: WA 프로토콜이 특정 코어 팀에 대한 의존 없이 완전히 운영되는 것.`},{id:12,title:"맺음말: Web4.0 비전과 함께 만들어가는 초대",icon:"Flag",content:`**WA 프로토콜은 단순한 프로젝트가 아닌, 디지털 문명의 실험입니다**
...
WA Protocol: Build the future. Together.`}]};export{e as whitepaperContent_ko};
