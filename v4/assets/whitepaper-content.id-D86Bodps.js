const a={sections:[{id:1,title:"Pendahuluan — Dari Web1.0 Menuju Web4.0",icon:"Globe",content:`"Setiap lompatan internet adalah rekonstruksi paradigma peradaban."
...
WA Protocol adalah protokol lalu lintas tingkat Web4.0 pertama dengan kemampuan "propagasi sendiri, eksekusi sendiri, pembatasan sendiri".`},{id:4,title:"Arsitektur Teknis: Sistem Operasi On-Chain untuk Web4.0",icon:"Code",content:`**Dari "DApp" ke "On-chain OS": sebuah pergeseran paradigma**
...
WA Protocol adalah sistem operasi on-chain tanpa kontrol, tanpa otorisasi, tanpa server — menyediakan fondasi operasi yang benar-benar native untuk Web4.0.`},{id:5,title:"Desain Mekanisme Inti: dari Viral menuju Otonomi",icon:"Settings",content:`**Dari viral pengguna, ke output nilai, hingga stabilisasi sistem — sebuah model operasi closed-loop yang lengkap**
...
Mekanisme WA membuat setiap insentif disertai biaya, setiap output menanggung tanggung jawab — mewujudkan ekosistem on-chain "insentif x tanggung jawab x eksekusi otonom".`},{id:6,title:"Sistem Ekonomi Dual-Token: Desain Simbiosis WANT dan XANT",icon:"Gem",content:`**Mengapa menggunakan model dual-token?**
...
Model dual-token memberi WA "ambang aktivasi" sekaligus "mekanisme keseimbangan diri" agar bisa berjalan jangka panjang.`},{id:7,title:"Closed-Loop Bisnis: Sistem Hematopoietik dan Aturan Insentif",icon:"TrendingUp",content:`**Latar belakang: Mengapa 90% proyek Web3 "tidak bisa menghidupi dirinya sendiri"?**
...
WA bukan "proyek yang menerbitkan token", melainkan "protokol ekonomi yang menghasilkan pendapatan nyata dan mendistribusikannya secara transparan on-chain".`},{id:8,title:"Sistem Pengendalian Risiko dan Desain Keberlanjutan",icon:"Shield",content:`**Mengapa pengendalian risiko harus "native-protocol"?**
...
Ini adalah OS on-chain baru yang "aturannya mengeksekusi dirinya sendiri".`},{id:9,title:"Peta Jalan dan Rencana Pengembangan Bertahap",icon:"Map",content:`**Prinsip pengembangan WA: "protokol dulu, produk kemudian"**
...
WA Protocol berkembang bukan karena "tim mendorong", melainkan karena "protokol menarik partisipan yang tepat pada waktu yang tepat".`},{id:10,title:"Desain Ekosistem MiniApp: Ruang Kedaulatan Digital Private Domain",icon:"Layout",content:`**Apa itu MiniApp dalam konteks WA?**
...
MiniApp adalah cara WA mewujudkan visi "internet milik penggunanya" — setiap builder memiliki kedaulatan penuh atas ruang digitalnya.`},{id:11,title:"Struktur Tim dan Latar Belakang",icon:"Users",content:`**Filosofi tim WA: "Protokol lebih besar dari tim"**
...
Tujuan akhir: WA Protocol berjalan sepenuhnya tanpa ketergantungan pada tim inti manapun.`},{id:12,title:"Penutup: Visi Web4.0 dan Undangan untuk Membangun Bersama",icon:"Flag",content:`**WA Protocol bukan sekadar proyek — ia adalah eksperimen peradaban digital**
...
WA Protocol: Build the future. Together.`}]};export{a as whitepaperContent_id};
