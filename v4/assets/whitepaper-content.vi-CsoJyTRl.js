const n={sections:[{id:1,title:"Mở đầu — Từ Web1.0 đến Web4.0",icon:"Globe",content:`"Mỗi lần Internet nhảy vọt là một lần tái cấu trúc mô thức văn minh."
...
WA Protocol, ra đời đúng lúc.`},{id:2,title:"Nền tảng triết học của Web4.0 và sứ mệnh của WA",icon:"Brain",content:`**Tái cấu trúc mô thức: Từ “sản phẩm Internet” đến “hệ thống sinh tồn số”**
...
WA Protocol là “hệ thống nền văn minh” mà chúng ta đang xây cho tương lai.`},{id:3,title:"Định vị của WA: Giao thức hợp tác lan truyền không cần quyền",icon:"Network",content:`**WA là gì? Không phải nền tảng, không phải sản phẩm — mà là giao thức**
...
WA Protocol là giao thức traffic cấp Web4.0 đầu tiên có khả năng “tự lan truyền, tự thực thi, tự ràng buộc”.`},{id:4,title:"Kiến trúc kỹ thuật: Hệ điều hành on-chain của Web4.0",icon:"Code",content:`**Từ “DApp” đến “On-chain OS”: Một bước ngoặt mô thức**
...
WA Protocol là một “hệ điều hành trên chain” không cần kiểm soát, không cần cấp quyền, không cần server, cung cấp hạ tầng vận hành thật sự cho Web4.0.`},{id:5,title:"Thiết kế cơ chế cốt lõi: Từ tăng trưởng lan truyền đến tự vận hành",icon:"Settings",content:`**Từ tăng trưởng lan truyền của người dùng → sinh giá trị → hệ thống tự cân bằng — mô hình vận hành vòng kín hoàn chỉnh**
...
WA đưa mọi khuyến khích đi kèm chi phí, mọi đơn vị sản lượng gánh trách nhiệm — thực hiện đúng nghĩa hệ sinh thái on-chain “khuyến khích × trách nhiệm × tự trị thực thi”.`},{id:6,title:"Hệ kinh tế hai token: WANT và XANT",icon:"Gem",content:`**Vì sao cần mô hình hai token?**
...
> Cơ chế hai token giúp WA có cả “ngưỡng khởi động” và “cơ chế tự cân bằng” để vận hành dài hạn.`},{id:7,title:"Vòng kín kinh doanh: Hệ thống tạo máu và quy tắc khuyến khích",icon:"TrendingUp",content:`**Bối cảnh: Tại sao 90% dự án Web3 "không thể tự nuôi sống"?**
...
WA không phải "dự án phát hành token", mà là "giao thức kinh tế tạo doanh thu thực và phân phối minh bạch trên chuỗi".`},{id:8,title:"Hệ thống quản lý rủi ro và thiết kế bền vững",icon:"Shield",content:`**Tại sao quản lý rủi ro phải "native-protocol"?**
...
WA không dựa vào "con người trung thực" mà dựa vào "hệ thống tự điều chỉnh".`},{id:9,title:"Lộ trình và kế hoạch phát triển theo giai đoạn",icon:"Map",content:`**Nguyên tắc phát triển WA: "giao thức trước, sản phẩm sau"**
...
WA Protocol phát triển không phải vì "đội ngũ thúc đẩy" mà vì "giao thức thu hút đúng người tham gia vào đúng thời điểm".`},{id:10,title:"Thiết kế hệ sinh thái MiniApp: Không gian chủ quyền số Private Domain",icon:"Layout",content:`**MiniApp trong WA là gì?**
...
MiniApp là cách WA hiện thực hóa tầm nhìn "internet thuộc về người dùng".`},{id:11,title:"Cấu trúc đội ngũ và nền tảng",icon:"Users",content:`**Triết lý đội ngũ WA: "Giao thức lớn hơn đội ngũ"**
...
Mục tiêu cuối cùng: WA Protocol vận hành hoàn toàn không phụ thuộc vào bất kỳ đội ngũ cốt lõi nào.`},{id:12,title:"Lời kết: Tầm nhìn Web4.0 và lời mời cùng xây dựng",icon:"Flag",content:`**WA Protocol không chỉ là một dự án — nó là một thí nghiệm văn minh số**
...
WA Protocol: Build the future. Together.`}]};export{n as whitepaperContent_vi};
