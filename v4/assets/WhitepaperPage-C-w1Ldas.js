...
WA Protocol adalah protokol lalu lintas tingkat Web4.0 pertama dengan kemampuan "propagasi sendiri, eksekusi sendiri, pembatasan sendiri".`}]}},Y=()=>{const r=[{feature:"AI智能分析",description:"基于深度学习的智能数据分析系统，提供实时洞察和预测"},{feature:"数据可视化",description:"直观的图表展示，支持多种数据格式和自定义样式"},{feature:"实时监控",description:"24/7全天候监控系统，及时发现异常并自动报警"},{feature:"云端同步",description:"多设备数据同步，随时随地访问和管理您的数据"}];return e.jsx("div",{className:"bg-white/5 border border-white/10 rounded-xl overflow-hidden backdrop-blur-sm",children:e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("table",{className:"table-fixed w-full",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"bg-white/5 border-b border-white/10",children:[e.jsx("th",{className:"w-1/3 px-6 py-4 text-left font-semibold text-white",children:"功能名称"}),e.jsx("th",{className:"w-2/3 px-6 py-4 text-left font-semibold text-white",children:"功能描述"})]})}),e.jsx("tbody",{children:r.map((u,d)=>e.jsxs("tr",{className:"hover:bg-white/5 transition-colors duration-200 border-b border-white/5 last:border-b-0",children:[e.jsx("td",{className:"px-6 py-4 text-slate-300 align-middle",children:e.jsx("span",{className:"inline-block text-sm leading-normal",children:u.feature})}),e.jsx("td",{className:"px-6 py-4 text-slate-300 align-middle",children:e.jsx("span",{className:"inline-block text-sm leading-normal",children:u.description})})]},d))})]})})})},J=[{id:"architecture-diagram",title:"架构总览图（逻辑结构）",keywords:["架构总览图","逻辑结构"],description:"WA Protocol 操作系统架构总览图",component:null},{id:"flow-diagram",title:"流程结构图（逻辑结构）",keywords:["流程结构图","逻辑结构"],description:"WA Protocol 用户参与流程结构图",component:null},{id:"business-loop-diagram",title:"商业闭环总图（逻辑结构）",keywords:["商业闭环总图","逻辑结构"],description:"WA Protocol 商业闭环总图",component:null},{id:"incentive-structure-diagram",title:"激励体系结构（四种类型）",keywords:["激励体系结构","四种类型"],description:"WA Protocol 激励体系结构图",component:null}],Q=r=>J.find(u=>u.keywords.every(d=>r.includes(d)))||null;class A{static components=new Map;static register(u,d){this.components.set(u,d)}static get(u){return this.components.get(u)||null}static getAll(){return new Map(this.components)}}const f="chart-registry-updated",O={registerComponents(){T(()=>import("./OptimizedArchitectureImage-x3wtUWdJ.js"),__vite__mapDeps([0,1,2])).then(r=>{A.register("architecture-diagram",r.default),window.dispatchEvent(new Event(f))}),T(()=>import("./FlowDiagramImage-BSDeDTic.js"),__vite__mapDeps([3,1,2])).then(r=>{A.register("flow-diagram",r.default),window.dispatchEvent(new Event(f))}),T(()=>import("./BusinessLoopImage-BJFALjUH.js"),__vite__mapDeps([4,1,2])).then(r=>{A.register("business-loop-diagram",r.default),window.dispatchEvent(new Event(f))}),T(()=>import("./IncentiveStructureImage-C_hTwAXZ.js"),__vite__mapDeps([5,1,2])).then(r=>{A.register("incentive-structure-diagram",r.default),window.dispatchEvent(new Event(f))})},renderChart(r,u,d){const y=Q(r);if(!y)return null;const m=A.get(y.id);return m?e.jsx("div",{className:"my-8",children:e.jsx(m,{...d})},`${y.id}-${u}`):null},getRegisteredCharts(){return A.getAll()},isChartRegistered(r){return A.get(r)!==null}},M=({text:r,index:u,language:d})=>{const[,y]=I.useState(0);return I.useEffect(()=>{const m=()=>y(W=>W+1);return window.addEventListener(f,m),()=>window.removeEventListener(f,m)},[]),O.renderChart(r,`chart-${u}`,{language:d})},Z=()=>{I.useEffect(()=>{O.registerComponents()},[])};function ee({language:r,setCurrentPage:u}){const[d,y]=k.useState(null),[m,W]=k.useState(null),w=_[r],x=F[r]||F.en;Z(),k.useEffect(()=>{const n=()=>{const i=x.sections;for(let l=i.length-1;l>=0;l--){const t=document.getElementById(`section-${i[l].id}`);if(t&&t.getBoundingClientRect().top<=80){y(i[l].id);break}}};return window.addEventListener("scroll",n,{passive:!0}),()=>window.removeEventListener("scroll",n)},[x.sections]),k.useEffect(()=>{window.scrollTo(0,0)},[]);const z=n=>{W(n);const i=document.getElementById(`section-${n}`);i&&i.scrollIntoView({behavior:"smooth",block:"start"})},L=n=>{W(m===n?null:n)},U=n=>{const i=n.split(`
`),l=[];let t=0;for(;t<i.length;){const c=i[t].trim();if(!c){t++;continue}if(c.startsWith("|")){let s=[];for(;t<i.length&&i[t].trim().startsWith("|");)s.push(i[t].trim()),t++;const h=s.filter(v=>v.trim());if(h.length>=2){const v=h[0].split("|").slice(1,-1).map(a=>a.trim()),o=v.length;let P=!1,N=0;const S=Array(Math.max(1,o)).fill(0);h.slice(2).forEach(a=>{a.split("|").slice(1,-1).forEach((C,g)=>{const D=C.trim().length;N=Math.max(N,D),S[g]=Math.max(S[g]??0,D),D>20&&(P=!0)})});const E=!P&&N<=14,G="text-sm",X="text-sm",V=E?"whitespace-nowrap":"whitespace-normal",K=E?"whitespace-nowrap":"whitespace-normal",j=a=>o===2?50:o===3?a===0?16:a===1?28:56:o===4?a===0?15:a===1||a===2?25:35:o===5?a===0?12:a===1||a===2||a===3?20:28:o===6?a===0?10:18:o===7?a===0?8:a===1||a===2||a===3||a===4||a===5?15:17:a===0?25:75/Math.max(1,o-1),p=o===2,q=P?"align-top":"align-middle",H=a=>p?a===0?"text-left":"text-center":o===3||o===4||o>=5||a===0?"text-left":(S[a]||0)<=8?"text-center":"text-left",B=a=>o===2?"px-8":o===3?a===0?"px-6":a===1?"px-4 border-x border-white/10":"px-6":o===4?a===0?"px-6":a===1||a===2?"px-3 border-r border-white/10":"px-6":o>=5?a===0||a===o-1?"px-4":"px-3 border-r border-white/10":"px-4";l.push(e.jsx("div",{className:"my-8",children:e.jsx("div",{className:"bg-white/5 border border-white/10 rounded-xl overflow-hidden backdrop-blur-sm",children:e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("table",{className:`table-fixed ${p?"mx-auto w-auto max-w-[500px]":"w-full min-w-[520px]"} border-0 border-separate`,style:{border:"none",borderCollapse:"separate",borderSpacing:"0"},children:[e.jsx("thead",{children:e.jsx("tr",{className:"bg-white/5 border-b border-white/10",children:v.map((a,b)=>e.jsx("th",{style:{width:`${j(b)}%`},className:`${B(b)} ${p?"py-4":"py-3"} font-semibold text-slate-100 align-middle ${p?b===0?"text-left":"text-center":(o===3||o===4||o>=5,"text-left")} ${!p&&o===3&&b===0?"whitespace-nowrap":K} ${!p&&o===3&&b===1?"whitespace-nowrap":""}`,children:e.jsx("span",{className:`inline-block ${G}`,children:a})},b))})}),e.jsx("tbody",{children:h.slice(2).map((a,b)=>e.jsx("tr",{className:"hover:bg-white/5 transition-colors border-0",style:{border:"none"},children:a.split("|").slice(1,-1).map((C,g)=>e.jsx("td",{style:{width:`${j(g)}%`,border:"none"},className:`${B(g)} ${p?"py-4":"py-3"} text-slate-300 ${!p&&o===3&&g===1?"":"break-words"} ${q} ${H(g)} ${!p&&o===3&&g===0?"whitespace-nowrap":V} ${!p&&o===3&&g===1?"whitespace-nowrap":""} border-0`,children:e.jsx("span",{className:`inline-block ${X} leading-normal`,children:C})},g))},b))})]})})})},t))}continue}if(c.startsWith("•")){let s=[];for(;t<i.length&&i[t].trim().startsWith("•");)s.push(i[t].trim()),t++;l.push(e.jsx("ul",{className:"space-y-3",children:s.map((h,v)=>e.jsxs("li",{className:"flex items-start gap-3 text-slate-300 leading-relaxed break-words",children:[e.jsx("span",{className:"inline-flex items-center justify-center w-2 h-2 bg-lime-400 rounded-full mt-2 flex-shrink-0"}),e.jsx("span",{dangerouslySetInnerHTML:{__html:h.substring(1).trim().replace(/\*\*(.*?)\*\*/g,'<strong class="text-white font-medium">$1</strong>').replace(/#YouTube#/g,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium rounded-lg border" style="background-color: rgb(220 38 38); border-color: rgb(220 38 38); color: rgb(255 255 255);">YouTube</span>').replace(/#Facebook#/g,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium rounded-lg border" style="background-color: rgb(37 99 235); border-color: rgb(37 99 235); color: rgb(255 255 255);">Facebook</span>').replace(/#微博#/g,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium rounded-lg border" style="background-color: rgb(225 29 72); border-color: rgb(225 29 72); color: rgb(255 255 255);">微博</span>').replace(/#Weibo#/gi,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium rounded-lg border" style="background-color: rgb(225 29 72); border-color: rgb(225 29 72); color: rgb(255 255 255);">Weibo</span>').replace(/#门户网站#/g,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium rounded-lg border" style="background-color: rgb(245 158 11); border-color: rgb(245 158 11); color: rgb(0 0 0);">门户网站</span>').replace(/#BBS#/gi,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium rounded-lg border" style="background-color: rgb(5 150 105); border-color: rgb(5 150 105); color: rgb(255 255 255);">BBS</span>').replace(/#早期博客#/g,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium rounded-lg border" style="background-color: rgb(101 163 13); border-color: rgb(63 98 18); color: rgb(255 255 255);">早期博客</span>').replace(/#([^#]+)#/g,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium bg-lime-500/10 text-lime-300 rounded-lg border border-lime-500/25">$1</span>')}})]},v))},t))}else if(c.startsWith("✅"))l.push(e.jsx("h4",{className:"flex items-center gap-4 text-xl font-light text-emerald-400 mt-8 mb-6",dangerouslySetInnerHTML:{__html:c.replace(/\*\*(.*?)\*\*/g,'<strong class="text-white font-medium">$1</strong>').replace("✅",'<span class="inline-flex items-center justify-center w-7 h-7 bg-emerald-500 text-white text-lg rounded-xl font-bold">✓</span>')}},t)),t++;else if(c.startsWith("**")&&c.endsWith("**")){const s=c.slice(2,-2);l.push(e.jsx("h3",{className:"text-xl font-light text-lime-400 mt-8 mb-6",children:s},t)),s==="架构总览图（逻辑结构）"&&l.push(e.jsx("div",{className:"my-8",children:e.jsx(Y,{})},`demo-${t}`)),l.push(e.jsx(M,{text:s,index:t,language:r},`chart-${t}`)),t++}else if(c.startsWith("###")){const s=c.replace("###","").trim(),h=s.startsWith("**")&&s.endsWith("**")?s.slice(2,-2):s;l.push(e.jsx("h3",{className:"text-xl font-light text-lime-400 mt-8 mb-6",children:h},t)),l.push(e.jsx(M,{text:h,index:t,language:r},`chart-${t}`)),t++}else if(c.startsWith("*")&&c.endsWith("*")){const s=c.slice(1,-1).trim();l.push(e.jsx("h3",{className:"text-xl font-light text-lime-400 mt-8 mb-6",children:s},t)),l.push(e.jsx(M,{text:s,index:t,language:r},`chart-${t}`)),t++}else if(c.startsWith(">"))l.push(e.jsx("blockquote",{className:"border-l-4 border-lime-500 pl-6 py-4 my-6 bg-lime-500/10 rounded-r-xl text-slate-300 italic leading-relaxed backdrop-blur-sm break-words",children:c.replace(">","").trim()},t)),t++;else if(c.startsWith("---"))l.push(e.jsx("div",{className:"my-12",children:e.jsx("div",{className:"border-t border-white/10"})},t)),t++;else{let s=c;for(;t+1<i.length&&i[t+1].trim()&&!i[t+1].trim().startsWith("|")&&!i[t+1].trim().startsWith("•")&&!i[t+1].trim().startsWith("**")&&!i[t+1].trim().startsWith("###")&&!i[t+1].trim().startsWith("*")&&!i[t+1].trim().startsWith("✅")&&!i[t+1].trim().startsWith(">")&&!i[t+1].trim().startsWith("---");)t++,s+=" "+i[t].trim();l.push(e.jsx("p",{className:"text-slate-300 leading-relaxed mb-4 break-words",dangerouslySetInnerHTML:{__html:s.replace(/\*(.*?)\*/g,'<strong class="text-white font-medium">$1</strong>').replace(/\*\*(.*?)\*\*/g,'<strong class="text-white font-medium">$1</strong>')}},t)),t++}}return e.jsx(e.Fragment,{children:l})};return e.jsxs("div",{className:"min-h-screen bg-[#0a0a0a] text-white",children:[e.jsxs("div",{className:"fixed inset-0 overflow-hidden z-[-1] opacity-60",children:[e.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[800px] bg-gradient-to-br from-lime-500/20 via-emerald-500/10 to-cyan-500/20 rounded-full blur-3xl animate-pulse"}),e.jsx("div",{className:"absolute top-1/3 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-gradient-to-tr from-blue-500/20 via-indigo-500/10 to-purple-500/20 rounded-full blur-3xl animate-pulse delay-700"}),e.jsx("div",{className:"absolute bottom-1/3 right-1/3 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[700px] bg-gradient-to-bl from-amber-500/20 via-orange-500/10 to-red-500/20 rounded-full blur-3xl animate-pulse delay-1400"})]}),e.jsxs("div",{className:"container mx-auto px-6 py-20 relative max-w-2xl lg:max-w-3xl",children:[e.jsx(R,{className:"absolute top-28 right-[15%] text-lime-400/40",size:16}),e.jsx(R,{className:"absolute top-48 left-[20%] text-lime-300/30",size:12}),e.jsx($,{className:"absolute bottom-32 right-[25%] text-lime-400/30",size:18}),e.jsxs("header",{className:"mb-24 text-center",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 px-4 py-1.5 mb-8 text-xs tracking-wide text-lime-300/90 bg-lime-500/5 border border-lime-500/20 rounded-full",children:[e.jsx("span",{className:"w-1.5 h-1.5 bg-lime-400 rounded-full animate-pulse"}),"Whitepaper Documentation"]}),e.jsx("h1",{className:"mb-8",children:e.jsx("div",{className:"text-4xl md:text-5xl lg:text-6xl text-white font-light tracking-tight mb-3",children:w.title})}),e.jsx("p",{className:"text-slate-400 text-lg mb-14 max-w-2xl mx-auto font-light leading-relaxed",children:w.subtitle})]}),e.jsx("nav",{className:"mb-24",children:e.jsxs("div",{className:"p-8 border border-white/10 hover:border-emerald-500/50 rounded-2xl transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10 bg-white/5 backdrop-blur-sm",children:[e.jsxs("h2",{className:"text-xl font-light text-white mb-8 flex items-center gap-3",children:[e.jsx("span",{className:"w-2 h-2 bg-lime-400 rounded-full animate-pulse"}),w.tableOfContents]}),e.jsx("div",{className:"grid gap-3",children:x.sections.map(n=>e.jsx("button",{onClick:()=>z(n.id),className:`group text-left p-5 rounded-xl transition-all duration-300 ${d===n.id?"bg-lime-600/20 border border-lime-500/30 text-lime-400 shadow-lg shadow-lime-500/10":"hover:bg-white/5 border border-transparent text-slate-300 hover:text-white hover:border-white/20"}`,children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 font-mono text-sm ${d===n.id?"bg-lime-600 text-white shadow-lg":"bg-white/10 text-slate-500 group-hover:bg-lime-600/20 group-hover:text-lime-400"}`,children:String(n.id).padStart(2,"0")}),e.jsxs("div",{children:[e.jsx("div",{className:`font-medium transition-colors duration-300 ${d===n.id?"text-lime-300":"text-white group-hover:text-lime-400"}`,children:n.title}),e.jsxs("div",{className:"text-xs text-slate-500 mt-1",children:["Chapter ",n.id]})]})]}),e.jsx("div",{className:`transition-all duration-300 ${d===n.id?"text-lime-400":"text-slate-600 group-hover:text-lime-400"}`,children:e.jsx("div",{className:"w-2 h-2 rounded-full bg-current"})})]})},n.id))})]})}),e.jsx("main",{className:"space-y-12",children:x.sections.map(n=>e.jsxs("article",{id:`section-${n.id}`,className:"group border border-white/10 hover:border-emerald-500/50 rounded-2xl transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10 hover:-translate-y-1 bg-white/5 backdrop-blur-sm overflow-hidden",children:[e.jsx("button",{onClick:()=>L(n.id),className:"w-full text-left p-8 hover:bg-white/5 transition-colors duration-300",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-6",children:[e.jsx("div",{className:`w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-300 font-mono text-lg font-bold ${m===n.id?"bg-lime-600 text-white shadow-lg shadow-lime-500/30":"bg-white/10 text-slate-400 group-hover:bg-lime-600/20 group-hover:text-lime-400"}`,children:String(n.id).padStart(2,"0")}),e.jsxs("div",{children:[e.jsx("h2",{className:`text-xl md:text-2xl font-light transition-colors duration-300 ${m===n.id?"text-lime-400":"text-white group-hover:text-lime-400"}`,children:n.title}),e.jsx("div",{className:"text-sm text-slate-500 mt-2",children:m===n.id?"Click to collapse":"Click to expand"})]})]}),e.jsx("div",{className:`flex items-center justify-center w-12 h-12 rounded-xl transition-all duration-300 ${m===n.id?"bg-lime-600 text-white rotate-45":"bg-white/10 text-slate-400 group-hover:bg-lime-600/20 group-hover:text-lime-400"}`,children:e.jsx("span",{className:"text-2xl font-light",children:m===n.id?"−":"+"})})]})}),m===n.id&&e.jsx("div",{className:"border-t border-white/10 bg-black/20",children:e.jsx("div",{className:"p-8",children:U(n.content)})})]},n.id))}),e.jsx("div",{className:"mt-24 text-center",children:e.jsxs("button",{onClick:()=>u("home"),className:"group px-8 py-4 text-sm font-medium text-white bg-lime-600 hover:bg-lime-500 rounded-xl transition-all duration-300 hover:shadow-xl hover:shadow-lime-500/25 flex items-center justify-center mx-auto gap-3 hover:-translate-y-1",children:[e.jsx("span",{className:"transition-transform duration-300 group-hover:-translate-x-1",children:"←"}),w.backToHome]})})]})]})}const ne=k.memo(ee);export{ne as WhitepaperPage};
