...
WA Protocol adalah protokol lalu lintas tingkat Web4.0 pertama dengan kemampuan "propagasi sendiri, eksekusi sendiri, pembatasan sendiri".`}]}},_=()=>{const r=[{feature:"AI智能分析",description:"基于深度学习的智能数据分析系统，提供实时洞察和预测"},{feature:"数据可视化",description:"直观的图表展示，支持多种数据格式和自定义样式"},{feature:"实时监控",description:"24/7全天候监控系统，及时发现异常并自动报警"},{feature:"云端同步",description:"多设备数据同步，随时随地访问和管理您的数据"}];return e.jsx("div",{className:"bg-white/5 border border-white/10 rounded-xl overflow-hidden backdrop-blur-sm",children:e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("table",{className:"table-fixed w-full",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"bg-white/5 border-b border-white/10",children:[e.jsx("th",{className:"w-1/3 px-6 py-4 text-left font-semibold text-white",children:"功能名称"}),e.jsx("th",{className:"w-2/3 px-6 py-4 text-left font-semibold text-white",children:"功能描述"})]})}),e.jsx("tbody",{children:r.map((d,m)=>e.jsxs("tr",{className:"hover:bg-white/5 transition-colors duration-200 border-b border-white/5 last:border-b-0",children:[e.jsx("td",{className:"px-6 py-4 text-slate-300 align-middle",children:e.jsx("span",{className:"inline-block text-sm leading-normal",children:d.feature})}),e.jsx("td",{className:"px-6 py-4 text-slate-300 align-middle",children:e.jsx("span",{className:"inline-block text-sm leading-normal",children:d.description})})]},m))})]})})})},Y=[{id:"architecture-diagram",title:"架构总览图（逻辑结构）",keywords:["架构总览图","逻辑结构"],description:"WA Protocol 操作系统架构总览图",component:null},{id:"flow-diagram",title:"流程结构图（逻辑结构）",keywords:["流程结构图","逻辑结构"],description:"WA Protocol 用户参与流程结构图",component:null},{id:"business-loop-diagram",title:"商业闭环总图（逻辑结构）",keywords:["商业闭环总图","逻辑结构"],description:"WA Protocol 商业闭环总图",component:null},{id:"incentive-structure-diagram",title:"激励体系结构（四种类型）",keywords:["激励体系结构","四种类型"],description:"WA Protocol 激励体系结构图",component:null}],J=r=>Y.find(d=>d.keywords.every(m=>r.includes(m)))||null;class y{static components=new Map;static register(d,m){this.components.set(d,m)}static get(d){return this.components.get(d)||null}static getAll(){return new Map(this.components)}}const R={registerComponents(){w(()=>import("./OptimizedArchitectureImage-CEqbeA9H.js"),__vite__mapDeps([0,1,2])).then(r=>{y.register("architecture-diagram",r.default)}),w(()=>import("./FlowDiagramImage-OQqWNIIC.js"),__vite__mapDeps([3,1,2])).then(r=>{y.register("flow-diagram",r.default)}),w(()=>import("./BusinessLoopImage-_FKSKCHA.js"),__vite__mapDeps([4,1,2])).then(r=>{y.register("business-loop-diagram",r.default)}),w(()=>import("./IncentiveStructureImage-ahtUhWB7.js"),__vite__mapDeps([5,1,2])).then(r=>{y.register("incentive-structure-diagram",r.default)})},renderChart(r,d){const m=J(r);if(!m)return null;const f=y.get(m.id);return f?e.jsx("div",{className:"my-8",children:e.jsx(f,{})},`${m.id}-${d}`):null},getRegisteredCharts(){return y.getAll()},isChartRegistered(r){return y.get(r)!==null}},C=({text:r,index:d})=>R.renderChart(r,`chart-${d}`),Q=()=>{q.useEffect(()=>{R.registerComponents()},[])};function Z({language:r,setCurrentPage:d}){const[m,f]=v.useState(null),[b,D]=v.useState(null),k=$[r],W=B[r]||B.en;Q(),v.useEffect(()=>{const n=()=>{const i=W.sections;for(let s=i.length-1;s>=0;s--){const t=document.getElementById(`section-${i[s].id}`);if(t&&t.getBoundingClientRect().top<=80){f(i[s].id);break}}};return window.addEventListener("scroll",n,{passive:!0}),()=>window.removeEventListener("scroll",n)},[W.sections]),v.useEffect(()=>{window.scrollTo(0,0)},[]);const F=n=>{D(n);const i=document.getElementById(`section-${n}`);i&&i.scrollIntoView({behavior:"smooth",block:"start"})},O=n=>{D(b===n?null:n)},z=n=>{const i=n.split(`
`),s=[];let t=0;for(;t<i.length;){const c=i[t].trim();if(!c){t++;continue}if(c.startsWith("|")){let l=[];for(;t<i.length&&i[t].trim().startsWith("|");)l.push(i[t].trim()),t++;const u=l.filter(A=>A.trim());if(u.length>=2){const A=u[0].split("|").slice(1,-1).map(a=>a.trim()),o=A.length;let x=!1,T=0;const P=Array(Math.max(1,o)).fill(0);u.slice(2).forEach(a=>{a.split("|").slice(1,-1).forEach((N,h)=>{const S=N.trim().length;T=Math.max(T,S),P[h]=Math.max(P[h]??0,S),S>20&&(x=!0)})});const M=!x&&T<=14,L="text-sm",U="text-sm",G=M?"whitespace-nowrap":"whitespace-normal",X=M?"whitespace-nowrap":"whitespace-normal",I=a=>o===2?50:o===3?a===0?16:a===1?28:56:o===4?a===0?15:a===1||a===2?25:35:o===5?a===0?12:a===1||a===2||a===3?20:28:o===6?a===0?10:18:o===7?a===0?8:a===1||a===2||a===3||a===4||a===5?15:17:a===0?25:75/Math.max(1,o-1),p=o===2,V=x?"align-top":"align-middle",K=a=>p?a===0?"text-left":"text-center":o===3||o===4||o>=5||a===0?"text-left":(P[a]||0)<=8?"text-center":"text-left",j=a=>o===2?"px-8":o===3?a===0?"px-6":a===1?"px-4 border-x border-white/10":"px-6":o===4?a===0?"px-6":a===1||a===2?"px-3 border-r border-white/10":"px-6":o>=5?a===0||a===o-1?"px-4":"px-3 border-r border-white/10":"px-4";s.push(e.jsx("div",{className:"my-8",children:e.jsx("div",{className:"bg-white/5 border border-white/10 rounded-xl overflow-hidden backdrop-blur-sm",children:e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("table",{className:`table-fixed ${p?"mx-auto w-auto max-w-[500px]":"w-full min-w-[520px]"} border-0 border-separate`,style:{border:"none",borderCollapse:"separate",borderSpacing:"0"},children:[e.jsx("thead",{children:e.jsx("tr",{className:"bg-white/5 border-b border-white/10",children:A.map((a,g)=>e.jsx("th",{style:{width:`${I(g)}%`},className:`${j(g)} ${p?"py-4":"py-3"} font-semibold text-slate-100 align-middle ${p?g===0?"text-left":"text-center":(o===3||o===4||o>=5,"text-left")} ${!p&&o===3&&g===0?"whitespace-nowrap":X} ${!p&&o===3&&g===1?"whitespace-nowrap":""}`,children:e.jsx("span",{className:`inline-block ${L}`,children:a})},g))})}),e.jsx("tbody",{children:u.slice(2).map((a,g)=>e.jsx("tr",{className:"hover:bg-white/5 transition-colors border-0",style:{border:"none"},children:a.split("|").slice(1,-1).map((N,h)=>e.jsx("td",{style:{width:`${I(h)}%`,border:"none"},className:`${j(h)} ${p?"py-4":"py-3"} text-slate-300 ${!p&&o===3&&h===1?"":"break-words"} ${V} ${K(h)} ${!p&&o===3&&h===0?"whitespace-nowrap":G} ${!p&&o===3&&h===1?"whitespace-nowrap":""} border-0`,children:e.jsx("span",{className:`inline-block ${U} leading-normal`,children:N})},h))},g))})]})})})},t))}continue}if(c.startsWith("•")){let l=[];for(;t<i.length&&i[t].trim().startsWith("•");)l.push(i[t].trim()),t++;s.push(e.jsx("ul",{className:"space-y-3",children:l.map((u,A)=>e.jsxs("li",{className:"flex items-start gap-3 text-slate-300 leading-relaxed break-words",children:[e.jsx("span",{className:"inline-flex items-center justify-center w-2 h-2 bg-lime-400 rounded-full mt-2 flex-shrink-0"}),e.jsx("span",{dangerouslySetInnerHTML:{__html:u.substring(1).trim().replace(/\*\*(.*?)\*\*/g,'<strong class="text-white font-medium">$1</strong>').replace(/#YouTube#/g,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium bg-red-500/20 text-red-400 rounded-lg border border-red-500/30">YouTube</span>').replace(/#Facebook#/g,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium bg-blue-500/20 text-blue-400 rounded-lg border border-blue-500/30">Facebook</span>').replace(/#微博#/g,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium bg-orange-500/20 text-orange-400 rounded-lg border border-orange-500/30">微博</span>').replace(/#([^#]+)#/g,'<span class="inline-flex items-center px-2 py-1 mx-1 text-xs font-medium bg-emerald-500/20 text-emerald-400 rounded-lg border border-emerald-500/30">$1</span>')}})]},A))},t))}else if(c.startsWith("✅"))s.push(e.jsx("h4",{className:"flex items-center gap-4 text-xl font-light text-emerald-400 mt-8 mb-6",dangerouslySetInnerHTML:{__html:c.replace(/\*\*(.*?)\*\*/g,'<strong class="text-white font-medium">$1</strong>').replace("✅",'<span class="inline-flex items-center justify-center w-7 h-7 bg-emerald-500 text-white text-lg rounded-xl font-bold">✓</span>')}},t)),t++;else if(c.startsWith("**")&&c.endsWith("**")){const l=c.slice(2,-2);s.push(e.jsx("h3",{className:"text-xl font-light text-lime-400 mt-8 mb-6",children:l},t)),l==="架构总览图（逻辑结构）"&&s.push(e.jsx("div",{className:"my-8",children:e.jsx(_,{})},`demo-${t}`));const u=C({text:l,index:t});u&&s.push(u),t++}else if(c.startsWith("###")){const l=c.replace("###","").trim();s.push(e.jsx("h3",{className:"text-xl font-light text-lime-400 mt-8 mb-6",children:l},t)),l==="**架构总览图（逻辑结构）**"&&s.push(e.jsx("div",{className:"my-8",children:e.jsx(OptimizedArchitectureImage,{})},`architecture-${t}`)),l==="**流程结构图（逻辑结构）**"&&s.push(e.jsx("div",{className:"my-8",children:e.jsx(FlowDiagramImage,{})},`flow-${t}`));const u=C({text:l,index:t});u&&s.push(u),t++}else if(c.startsWith("*")&&c.endsWith("*")){const l=c.slice(1,-1).trim();s.push(e.jsx("h3",{className:"text-xl font-light text-lime-400 mt-8 mb-6",children:l},t));const u=C({text:l,index:t});u&&s.push(u),t++}else if(c.startsWith(">"))s.push(e.jsx("blockquote",{className:"border-l-4 border-lime-500 pl-6 py-4 my-6 bg-lime-500/10 rounded-r-xl text-slate-300 italic leading-relaxed backdrop-blur-sm break-words",children:c.replace(">","").trim()},t)),t++;else if(c.startsWith("---"))s.push(e.jsx("div",{className:"my-12",children:e.jsx("div",{className:"border-t border-white/10"})},t)),t++;else{let l=c;for(;t+1<i.length&&i[t+1].trim()&&!i[t+1].trim().startsWith("|")&&!i[t+1].trim().startsWith("•")&&!i[t+1].trim().startsWith("**")&&!i[t+1].trim().startsWith("###")&&!i[t+1].trim().startsWith("*")&&!i[t+1].trim().startsWith("✅")&&!i[t+1].trim().startsWith(">")&&!i[t+1].trim().startsWith("---");)t++,l+=" "+i[t].trim();s.push(e.jsx("p",{className:"text-slate-300 leading-relaxed mb-4 break-words",dangerouslySetInnerHTML:{__html:l.replace(/\*(.*?)\*/g,'<strong class="text-white font-medium">$1</strong>').replace(/\*\*(.*?)\*\*/g,'<strong class="text-white font-medium">$1</strong>')}},t)),t++}}return s};return e.jsxs("div",{className:"min-h-screen bg-[#0a0a0a] text-white",children:[e.jsxs("div",{className:"fixed inset-0 overflow-hidden z-[-1] opacity-60",children:[e.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[800px] bg-gradient-to-br from-lime-500/20 via-emerald-500/10 to-cyan-500/20 rounded-full blur-3xl animate-pulse"}),e.jsx("div",{className:"absolute top-1/3 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-gradient-to-tr from-blue-500/20 via-indigo-500/10 to-purple-500/20 rounded-full blur-3xl animate-pulse delay-700"}),e.jsx("div",{className:"absolute bottom-1/3 right-1/3 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[700px] bg-gradient-to-bl from-amber-500/20 via-orange-500/10 to-red-500/20 rounded-full blur-3xl animate-pulse delay-1400"})]}),e.jsxs("div",{className:"container mx-auto px-6 py-20 relative max-w-2xl lg:max-w-3xl",children:[e.jsx(E,{className:"absolute top-28 right-[15%] text-lime-400/40",size:16}),e.jsx(E,{className:"absolute top-48 left-[20%] text-lime-300/30",size:12}),e.jsx(H,{className:"absolute bottom-32 right-[25%] text-lime-400/30",size:18}),e.jsxs("header",{className:"mb-24 text-center",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 px-4 py-1.5 mb-8 text-xs tracking-wide text-lime-300/90 bg-lime-500/5 border border-lime-500/20 rounded-full",children:[e.jsx("span",{className:"w-1.5 h-1.5 bg-lime-400 rounded-full animate-pulse"}),"Whitepaper Documentation"]}),e.jsx("h1",{className:"mb-8",children:e.jsx("div",{className:"text-4xl md:text-5xl lg:text-6xl text-white font-light tracking-tight mb-3",children:k.title})}),e.jsx("p",{className:"text-slate-400 text-lg mb-14 max-w-2xl mx-auto font-light leading-relaxed",children:k.subtitle})]}),e.jsx("nav",{className:"mb-24",children:e.jsxs("div",{className:"p-8 border border-white/10 hover:border-emerald-500/50 rounded-2xl transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10 bg-white/5 backdrop-blur-sm",children:[e.jsxs("h2",{className:"text-xl font-light text-white mb-8 flex items-center gap-3",children:[e.jsx("span",{className:"w-2 h-2 bg-lime-400 rounded-full animate-pulse"}),k.tableOfContents]}),e.jsx("div",{className:"grid gap-3",children:W.sections.map(n=>e.jsx("button",{onClick:()=>F(n.id),className:`group text-left p-5 rounded-xl transition-all duration-300 ${m===n.id?"bg-lime-600/20 border border-lime-500/30 text-lime-400 shadow-lg shadow-lime-500/10":"hover:bg-white/5 border border-transparent text-slate-300 hover:text-white hover:border-white/20"}`,children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 font-mono text-sm ${m===n.id?"bg-lime-600 text-white shadow-lg":"bg-white/10 text-slate-500 group-hover:bg-lime-600/20 group-hover:text-lime-400"}`,children:String(n.id).padStart(2,"0")}),e.jsxs("div",{children:[e.jsx("div",{className:`font-medium transition-colors duration-300 ${m===n.id?"text-lime-300":"text-white group-hover:text-lime-400"}`,children:n.title}),e.jsxs("div",{className:"text-xs text-slate-500 mt-1",children:["Chapter ",n.id]})]})]}),e.jsx("div",{className:`transition-all duration-300 ${m===n.id?"text-lime-400":"text-slate-600 group-hover:text-lime-400"}`,children:e.jsx("div",{className:"w-2 h-2 rounded-full bg-current"})})]})},n.id))})]})}),e.jsx("main",{className:"space-y-12",children:W.sections.map(n=>e.jsxs("article",{id:`section-${n.id}`,className:"group border border-white/10 hover:border-emerald-500/50 rounded-2xl transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10 hover:-translate-y-1 bg-white/5 backdrop-blur-sm overflow-hidden",children:[e.jsx("button",{onClick:()=>O(n.id),className:"w-full text-left p-8 hover:bg-white/5 transition-colors duration-300",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-6",children:[e.jsx("div",{className:`w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-300 font-mono text-lg font-bold ${b===n.id?"bg-lime-600 text-white shadow-lg shadow-lime-500/30":"bg-white/10 text-slate-400 group-hover:bg-lime-600/20 group-hover:text-lime-400"}`,children:String(n.id).padStart(2,"0")}),e.jsxs("div",{children:[e.jsx("h2",{className:`text-xl md:text-2xl font-light transition-colors duration-300 ${b===n.id?"text-lime-400":"text-white group-hover:text-lime-400"}`,children:n.title}),e.jsx("div",{className:"text-sm text-slate-500 mt-2",children:b===n.id?"Click to collapse":"Click to expand"})]})]}),e.jsx("div",{className:`flex items-center justify-center w-12 h-12 rounded-xl transition-all duration-300 ${b===n.id?"bg-lime-600 text-white rotate-45":"bg-white/10 text-slate-400 group-hover:bg-lime-600/20 group-hover:text-lime-400"}`,children:e.jsx("span",{className:"text-2xl font-light",children:b===n.id?"−":"+"})})]})}),b===n.id&&e.jsx("div",{className:"border-t border-white/10 bg-black/20",children:e.jsx("div",{className:"p-8",children:z(n.content)})})]},n.id))}),e.jsx("div",{className:"mt-24 text-center",children:e.jsxs("button",{onClick:()=>d("home"),className:"group px-8 py-4 text-sm font-medium text-white bg-lime-600 hover:bg-lime-500 rounded-xl transition-all duration-300 hover:shadow-xl hover:shadow-lime-500/25 flex items-center justify-center mx-auto gap-3 hover:-translate-y-1",children:[e.jsx("span",{className:"transition-transform duration-300 group-hover:-translate-x-1",children:"←"}),k.backToHome]})})]})]})}const ae=v.memo(Z);export{ae as WhitepaperPage};
